...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<br></br>
			<form id="form_updateCase" action="updateCase.php" method="post">
				<?php
			    session_start();
				...
				<div class="row">
					...
					<div class="col-md-3">
						<input type="text" class="form-control" placeholder="<?php echo $lang['case_sender']; ?>" onkeyup="valid(this)" onblur="valid(this)" value='<?php echo $sender ?>'>
					</div>
					<div class="col-md-4">
				...
				?>
				<textarea class="form-control .input-lg" rows="5" placeholder="<?php echo $lang['case_comment']; ?>" name="attorneyComment" id="attorneyComment"></textarea>
				...
				<div> 
					<label class="checkbox-inline"> 
						<input type="radio" name="Estado" id="Procesado" value="Procesado" <?php if($estado =='Procesado') { echo 'checked'; } ?> > <?php echo $lang['status_processed']; ?>
					</label> 
					<label class="checkbox-inline">
						<input type="radio" name="Estado" id="NoProcesado" value="No" <?php if($estado !='Procesado') { echo 'checked'; } ?> > <?php echo $lang['status_not_processed']; ?> 
					</label> 
				</div>

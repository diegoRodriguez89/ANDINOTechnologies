			...
			<form class="form-horizontal" role="form" id="employeeInfo" action="addEmployee.php" method="post">
				<div class="form-group"> 
					...
					<div class="col-sm-5">
						...
						<input type="text" class="form-control" id="employeeName" name="employeeName" placeholder="<?php print $lang['eFirstName']; ?>" onkeyup="valid(this)" onblur="valid(this)"> 
					</div>
				</div> 
				...
				<div class="form-group"> 
					...
					<div class="col-sm-5">
						...
						<input type="text" class="form-control" id="employeeLastname" name="employeeLastname" placeholder="<?php print $lang['eLastName']; ?>" onkeyup="valid(this)" onblur="valid(this)"> 
					</div> 
				</div> 
				...
				<div class="form-group"> 
					<label for="Type_Employee" class="col-sm-2 control-label">
						<?php
							print   $lang['eType']; 
						?>:</label>
				...
				<div class="form-group"> 
					...
					<div class="col-sm-5">
						<!-- This input text is for the second last name of the employee -->
						<input type="text" class="form-control" id="Username" name="Username" placeholder="<?php print $lang['eTemporaryUser'];?>" onkeyup="valid(this)" onblur="valid(this)"> 
					</div> 
				</div> 
				...
				<div class="form-group"> 
					...
					<div class="col-sm-5">
						<!-- This input text is for the second last name of the employee -->
						<input type="password" class="form-control" id="passWord" name="passWord" placeholder="<?php print $lang['eTemporaryPass'];?>" onkeyup="valid(this)" onblur="valid(this)"> 
					</div> 
				</div> 
				...
				<div class="row">
					...
					<a class="btn btn-primary pull-right" href="employeeListhtml.php"> <?php print $lang['eCancel'];?></a>
					<!-- This button is for adding a employee to the system -->
					<button class="btn btn-primary pull-right" style="margin-right: 4px" type="submit" form="employeeInfo"><?php print $lang['eSubmit'];?></button>
				</div>
